...
<%@ page import="com.wingstudioly.guard.bean.Car_set" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <h4 class="margin-bottom-15">业主车位信息表</h4>
                            <table class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                <% ArrayList<Car_set> cars = (ArrayList<Car_set>) request.getSession().getAttribute("cars");
                                    String words = "无";
                                    String word2 = "无";
                                    for (Car_set car_set :
                                            cars) {
                                %>
                                <tr>
                                    <th><%=car_set.getCar_id()%>
                                    </th>
                                    <%

                                        if (car_set.getStatus() == 1)
                                            words = "有固定车位";
                                        if (car_set.getStatus() == 2)
                                            words = "无固定车位";
                                    %>
                                    <th><%=words%>
                                    </th>
                                    <%
                                        ...
                                        String dt = sdf.format(car_set.getTax_Date());
                                        word2 = dt;
                                    %>
                                    <th><%=word2%>
                                    </th>
