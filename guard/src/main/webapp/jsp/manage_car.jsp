                ...
                <div class="row margin-bottom-30">
                    <div class="col-md-12">
                        <ul class="nav nav-pills">
                            <li>今日车流进<span class="badge">${in}</span></li>
                            <li>今日车流出<span class="badge">${out}</span></li>
                            <li>车位剩余量<span class="badge">${emptyC}</span></li>
                        </ul>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel-body">
                            <span class="btn btn-primary"><a href="manage_tmpCar.html">查看临时车辆</a></span>
                        </div>


                        <div class="table-responsive">
                            <h4 class="margin-bottom-15">在场车辆信息表</h4>
