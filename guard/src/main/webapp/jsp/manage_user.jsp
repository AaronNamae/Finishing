            ...
            <div class="templatemo-content">
                ...
                <div class="row margin-bottom-30">
                    <div class="col-md-12">
                        <ul class="nav nav-pills">
                            <li>购买固定车位的业主  <span class="badge">${IN}</span></li>
                            <li>未购买固定车位的业主<span class="badge">${EX}</span></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel-body">
                            <span class="btn btn-primary"><a href="addUser.html">添加业主</a></span>
                        </div>

                    </div>
                    <div class="table-responsive">

                        <h4 class="margin-bottom-15">业主信息记录表</h4>
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <%
                                    if (us.getStatus() == 1) words = "有固定车位";
                                    if (us.getStatus() == 2) words = "无固定车位";
                                    if (us.getStatus() == 0) words = "未购买车位";
                                %>
                                <td><%=words%>
                                </td>
                                <td><%=us.getCar_id()%>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="user_update.html?per_id=<%=us.getPer_id()%>">修改</a></li>
                                            <li><a href="deleteUser.html?per_id=<%=us.getPer_id()%>">删除</a></li>
                                        </ul>
                                    </div>
                                </td>
                                <%
