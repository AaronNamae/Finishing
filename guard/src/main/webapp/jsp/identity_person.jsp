...
<script>
    ...
    function base64ToFile(data) {
        ...
        let file = new File([fileData], '2.jpg', { type: mime });
        ...
        reader.onload = function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.code == 0) {
                        $("#message").html("");
                        var messageInput10 = "<div class=\"alert alert-success alert-dismissible\" role=\"alert\">\n" +
                            "                            <button type=\"button\" class=\"close\" data-dismiss=\"alert\"><span\n" +
                            "                                    aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button>\n" +
                            "                            <strong>识别成功!</strong> 为小区业主，已自动放行.\n" +
                            "                        </div>";
                        $("#message").html(messageInput10);


                    } else if(data.code == 15){
                        $("#message").html("");
                        var messageInput9 = "<div class=\"alert alert-warning alert-dismissible\" role=\"alert\">\n" +
                            "                            <button type=\"button\" class=\"close\" data-dismiss=\"alert\"><span\n" +
                            "                                    aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button>\n" +
                            "                            <strong>陌生人！</strong> 请联系门卫.\n" +
                            "                        </div>";
                        $("#message").html(messageInput9);
            ...
            reader.onload = function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.code == 0) {
                            var messageInput8 = "<div class=\"alert alert-success alert-dismissible\" role=\"alert\">\n" +
                                "                            <button type=\"button\" class=\"close\" data-dismiss=\"alert\"><span\n" +
                                "                                    aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button>\n" +
                                "                            <strong>识别成功!</strong> " +
                                "                        </div>";
                            $("#message").append(messageInput8);
                            // $("#panel_EX").hide();
                            // $("#panel_IN").show();
                            // $("#infoContainer").empty();
