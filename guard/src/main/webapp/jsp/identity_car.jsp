...
<%--                                </div>--%>
                            ...
                            <div class="col-md-5 col-sm-6 margin-bottom-80">
                                ...
                                <div class="col-md-12">
                                    <h3>
                                        <p style="text-align: right;color: black;position: absolute" id="info"></p><br/>
                                    </h3>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function base64ToFile(data) {
        ...
        let file = new File([fileData], '1.jpg', { type: mime });
                    ...
                    if (data.stateCode == 1) {
                        ...
                        if (data.car_isIN == 1) {
                            var messageInput1 = "<div class=\"alert alert-success alert-dismissible\" role=\"alert\">\n" +
                                ...
                                "                        </div>";
                            $("#message").html(messageInput1);
                        } else if (data.car_isIN == 2) {
                            var messageInput6 = "<div class=\"alert alert-success alert-dismissible\" role=\"alert\">\n" +
                                "                            <button type=\"button\" class=\"close\" data-dismiss=\"alert\"><span\n" +
                                "                                    aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button>\n" +
                                "                            <strong>识别成功!</strong> 为小区非固定车位业主车，已自动放行.\n" +
                                "                        </div>";
                            $("#message").html(messageInput6);
                            ...
                            var messageInput2 = "<div class=\"alert alert-warning alert-dismissible\" role=\"alert\">\n" +
                                ...
                                "                        </div>";
                            $("#message").html(messageInput2);
                        } else if (data.car_isIN == -4){
                            var messageInput12 = "<div class=\"alert alert-danger alert-dismissible\" role=\"alert\">\n" +
                                "                            <button type=\"button\" class=\"close\" data-dismiss=\"alert\"><span\n" +
                                "                                    aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button>\n" +
                                "                            <strong>请勿重复进入!</strong>\n" +
                                "                        </div>";
                            $("#message").html(messageInput12);
                    ...
                    if (data.stateCode == 0) {
                        ...
                        if (data.car_isIN == 1) {
                            var messageInput4 = "<div class=\"alert alert-success alert-dismissible\" role=\"alert\" >\n" +
                                ...
                                "                        </div>";
                            $("#message").html(messageInput4)

                        }
                        //2代表非固定车位临时车
                        if (data.car_isIN == 2) {
                            var messageInput7 = "<div class=\"alert alert-success alert-dismissible\" role=\"alert\" >\n" +
                                "                            <button type=\"button\" class=\"close\" data-dismiss=\"alert\"><span\n" +
                                "                                    aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button>\n" +
                                "                            <strong>识别成功!</strong> \n" +
                                "                            <p id=\"info_EX\">为小区非固定车位业主车，已自动放行.</p>\n" +
                                "                        </div>";
                            $("#message").html(messageInput7);
