/**
 * ClassName: faceEngineService <br/>
 * Description: <br/>
 * date: 2021/5/9 20:30<br/>
 *
 * @author li yi<br/>
 */
...
import com.wingstudioly.guard.factory.FaceEngineFactory;
...
public class faceEngineService {
    ...
    private final static Logger logger = LoggerFactory.getLogger(faceEngineService.class);
    ...
    public faceEngineService(userInfoDao userInfoDao) {
    ...
    public List<FaceUserInfo> compareFaceFeature(byte[] faceFeature /*, Integer groupId*/ ) throws InterruptedException, ExecutionException {
        ...
        //数据库操作
        List<FaceUserInfo> faceInfoList = userInfoDao.getUserFaceInfo(); //从数据库中取出人脸库
